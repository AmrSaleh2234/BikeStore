<?php require APPROOT.DS.'views'.DS.'inc'.DS.'header.php'; // Directory sperator / or \?>
    <div class="forms">
        <!-- Start Sign Up Form -->
        <section class="main-form">
            <div class="container">
                <div class="row">
                    ...
                    <form class="row" method="POST" action="<?=URLROOT ?>/users/register">
                        <div class="col-12 pl-0 pr-0 mb-2 mt-2 ">
                            <input class="form-control form-control-lg <?php echo (!empty($data['firstName_err'])) ? 'is-invalid' : '' ?>" type="text" name="firstName" id="firstName" placeholder="First Name" value="<?php echo $data['firstName'] ?>" />
                            <div class="invalid-feedback"><?php echo $data['firstName_err'] ?></div>
                        </div>
                        <div class="col-12 pl-0 pr-0 mb-2 mt-2">
                            <input class="form-control form-control-lg <?php echo (!empty($data['lastName_err'])) ? 'is-invalid' : '' ?>" type="text" name="lastName" id="lastName" placeholder="Last Name" value="<?php echo $data['lastName'] ?>" />
                        ...
                        <div class="col-12 pl-0 pr-0 mb-2 mt-2">
                            <input class="form-control form-control-lg <?php echo (!empty($data['pass_err'])) ? 'is-invalid' : '' ?>" type="password" name="pass" id="password" placeholder="Type Password" value="<?php echo $data['pass'] ?>" />
                            <div class="invalid-feedback"><?php echo $data['pass_err'] ?></div>
                        </div>
                        <div class="col-12 pl-0 pr-0 mb-2 mt-2">
                            <input class="form-control form-control-lg <?php echo (!empty($data['repass_err'])) ? 'is-invalid' : '' ?>" type="password" name="rePass" id="secpassword" placeholder="Retype Password" value="<?php echo $data['rePass'] ?>" />
