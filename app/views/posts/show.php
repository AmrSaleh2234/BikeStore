        ...
        <div class="container">
            <div class="row">
                <div class="col-md-9 col-sm-12 post_page_column mx-auto">
                    <h2>
                        <?php echo $data['post'][0]->postTitle; ?>
                    </h2>
                    <div class="user">
                        <i class="fas fa-user"></i><span class="ml-2"><?php echo $data['post'][0]->username; ?></span>
                    </div>
                    <div class="post_img text-center">
                        <img src="<?php echo URLROOT ?>/img/uploads/<?php echo $data['post'][0]->photoName ?>" alt="photo" />
                    </div>
                    <p>
                        <?php echo $data['post'][0]->postContent; ?>
                    </p>
                </div>
            </div>
        </div>
